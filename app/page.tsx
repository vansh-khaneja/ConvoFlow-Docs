...
export default function Home() {
  return (
    <div className="w-full">
      ...
      <div className="mb-20 relative overflow-hidden min-h-[600px] lg:min-h-[700px]">
        <div className="max-w-7xl mx-auto px-8 py-12 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            {/* Left Side - Content */}
            <div className="space-y-8 font-[var(--font-plus-jakarta)]">
              <div className="inline-block px-3 py-1 bg-blue-100 text-blue-800 text-sm font-medium rounded-full">
                Documentation
              </div>
              <h1 className="text-5xl font-bold text-[var(--text-primary)] leading-tight tracking-tight">
        ...
        {/* Right Side - Image (Larger, Half Cut, Touching Right Edge) */}
        <div className="absolute right-0 top-[42%] -translate-y-1/2 lg:translate-x-48 translate-x-8 w-full lg:w-[60%] pointer-events-none h-full flex items-center">
      ...
      <div className="mb-20 pt-12 border-t border-gray-200">
        <div className="grid lg:grid-cols-[1fr_2fr] gap-12 items-start">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <a href="/examples/customer-support" className="group border border-[var(--border-color)] rounded-xl p-6 hover:border-[var(--accent)] hover:shadow-lg transition-all">
            ...
            <a href="/examples/document-qa" className="group border border-[var(--border-color)] rounded-xl p-6 hover:border-[var(--accent)] hover:shadow-lg transition-all">
            ...
            <a href="/examples/research-assistant" className="group border border-[var(--border-color)] rounded-xl p-6 hover:border-[var(--accent)] hover:shadow-lg transition-all">
            ...
            <a href="/examples/intent-routing" className="group border border-[var(--border-color)] rounded-xl p-6 hover:border-[var(--accent)] hover:shadow-lg transition-all">
      ...
      <div className="mb-20 pt-12 border-t border-gray-200">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <a href="/guides/configuration" className="group bg-white border border-gray-200 rounded-xl p-6 hover:border-[var(--accent)] hover:shadow-lg transition-all">
            <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center mb-4">
              <svg className="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <a href="/examples/basic-chatbot" className="group bg-white border border-gray-200 rounded-xl p-6 hover:border-[var(--accent)] hover:shadow-lg transition-all">
            <div className="w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center mb-4">
              <svg className="w-6 h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <a href="/guides/workflows" className="group bg-white border border-gray-200 rounded-xl p-6 hover:border-[var(--accent)] hover:shadow-lg transition-all">
            <div className="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center mb-4">
              <svg className="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <a href="/reference/api" className="group bg-white border border-gray-200 rounded-xl p-6 hover:border-[var(--accent)] hover:shadow-lg transition-all">
            <div className="w-12 h-12 bg-orange-100 rounded-lg flex items-center justify-center mb-4">
              <svg className="w-6 h-6 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <a href="/customization/adding-nodes" className="group bg-white border border-gray-200 rounded-xl p-6 hover:border-[var(--accent)] hover:shadow-lg transition-all">
          ...
          <a href="/guides/troubleshooting" className="group bg-white border border-gray-200 rounded-xl p-6 hover:border-[var(--accent)] hover:shadow-lg transition-all">
      ...
      <div className="mb-20 pt-12 border-t border-gray-200">
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-3">
            <button className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-[var(--text-secondary)] hover:text-[var(--text-primary)] border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
